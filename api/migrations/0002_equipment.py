    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=None, max_length=8, validators=[django.core.validators.RegexValidator(code='invalid_code', message='Code must be alphanumeric', regex='^[A-Za-z0-9]*$')], verbose_name='Code')),
