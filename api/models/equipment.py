...
class Equipment(AbstractModel):
    ...
    Equipment model
    """
    vessel = models.ForeignKey(Vessel, null=False, blank=False, on_delete=models.CASCADE, verbose_name='Vessel')
    name = models.CharField(null=False, blank=False, max_length=50, verbose_name='Name')
    code = models.CharField(null=False, blank=False, unique=True, max_length=8, verbose_name='Code', validators=[
        RegexValidator(
            regex=r'^[A-Za-z0-9]*$',
